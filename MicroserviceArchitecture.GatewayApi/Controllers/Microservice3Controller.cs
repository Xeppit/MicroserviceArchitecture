...
namespace MicroserviceArchitecture.GatewayApi.Controllers
{
    ...
    [ApiController]
    public class Microservice3Controller : ControllerBase
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly TokenService _tokenService;

        public Microservice3Controller(IHttpClientFactory httpClient, TokenService tokenService)
        {
        ...
        public async Task<IEnumerable<WeatherForecast>> Get()
        {
            ...
            var response = await client.GetAsync("https://localhost:5005/WeatherForecast");
