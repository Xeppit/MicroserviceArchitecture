...
namespace MicroserviceArchitecture.GatewayApi.Controllers
{
    ...
    public class Microservice1Controller : ControllerBase
    {
        ...
        public Microservice1Controller(IHttpClientFactory httpClient, TokenService tokenService)
        {
        ...
        public async Task<IEnumerable<WeatherForecast>> Get()
        {
            ...
            var response = await client.GetAsync("https://localhost:5003/WeatherForecast");
